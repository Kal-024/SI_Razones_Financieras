...
CREATE TABLE DBO.DOCUMENTOS (ID INT IDENTITY, NOMBRE VARCHAR(255), CONTENIDO VARBINARY(MAX), EXTENSION CHAR(4))
--		Insertando el docx
INSERT INTO DBO.DOCUMENTOS (NOMBRE,CONTENIDO,EXTENSION)
SELECT 'DATOSDERAZONESDELIQUIDEZPARAPROYECTODECURSO', BULKCOLUMN, 'docx'
FROM OPENROWSET(BULK N'C:\Backups\DATOSDERAZONESDELIQUIDEZPARAPROYECTODECURSO.docx',SINGLE_BLOB) as MyAlias
SELECT D.CONTENIDO FROM DOCUMENTOS as D
...
/*		Datos usado en el ejemplo para el proyecto a presentar
